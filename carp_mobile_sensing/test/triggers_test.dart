...
//  });
  ...
  group('Trigger Tests', () {
    test(' - RecurrentScheduledTrigger - success', () {
      ...
      t = RecurrentScheduledTrigger(type: RecurrentType.weekly, dayOfWeek: DateTime.thursday, time: Time(hour: 14, minute: 23));
      print('${t.firstOccurrence} - ${t.period}');
      expect(t.period.inDays, 7);

      // collect every 2nd thursday at 14:00
      t = RecurrentScheduledTrigger(type: RecurrentType.weekly, dayOfWeek: DateTime.thursday, separationCount: 1, time: Time(hour: 14, minute: 00));
      print('${t.firstOccurrence} - ${t.period}');
    ...
    test(' - CronScheduledTrigger', () {
      ...
      t = CronScheduledTrigger(triggerId: 'id', minute: 10, hour: 12, day: 5, month: DateTime.april, weekday: DateTime.tuesday);
      print(t);
    });

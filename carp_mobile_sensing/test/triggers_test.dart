...
//  });
  ...
  group('Trigger Tests', () {
    test(' - RecurrentScheduledTrigger - success', () {
      ...
      print('weekly, Thursday at 14:00 :: first : ${t.firstOccurrence} - period : ${t.period}');
      ...
      print('monthly, 1st day of month at 18:00 :: first : ${t.firstOccurrence} - period : ${t.period}');
      ...
      print('quarterly, 11th day of month at 21:30 :: first : ${t.firstOccurrence} - period : ${t.period}');
      ...
      print('monthly, 2nd week of month on Tuesday at 14:30 :: first : ${t.firstOccurrence} - period : ${t.period}');

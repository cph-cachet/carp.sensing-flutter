  ...
  Future<Study> _getStudyWithMostMeasuresFromDebugSamplingSchema(String studyId) async {
    if (_study == null) {
      _study = Study(studyId, bloc.username)
            ...
            ..description = 'This study is generated by using the debug Sampling Schema all Sampling Packages. '
            ..dataEndPoint = getDataEndpoint(DataEndPointTypes.FILE)
            ..addTriggerTask(
                ImmediateTrigger(),
                Task()
...
//               ))
            ...
            ..addTriggerTask(
                PeriodicTrigger(period: Duration(seconds: 30), duration: Duration(seconds: 10)),
                Task()

  ...
  test('Triggers -> JSON', () async {
    ...
    study_3.addTriggerTask(
        ...
        AutomaticTask(name: 'Sensing Task #2')
          ..measures = SamplingSchema.common().getMeasureList(types: [SensorSamplingPackage.LIGHT, DeviceSamplingPackage.DEVICE]));
    ...
    print('$t1');
    study_3.addTriggerTask(
        t1, AutomaticTask(name: 'Sensing Task #1')..measures = SamplingSchema.common().getMeasureList(types: [DeviceSamplingPackage.MEMORY]));
    ...
    study_3.addTriggerTask(
        t2,
        AutomaticTask(name: 'Sensing Task #1')
          ..measures = SamplingSchema.common().getMeasureList(types: [SensorSamplingPackage.LIGHT, DeviceSamplingPackage.MEMORY]));
    ...
    study_3.addTriggerTask(
        t3,
        AutomaticTask(name: 'Sensing Task #1')
          ..measures = SamplingSchema.common().getMeasureList(types: [SensorSamplingPackage.LIGHT, DeviceSamplingPackage.BATTERY]));
    ...
    study_3.addTriggerTask(
        t4,
        AutomaticTask(name: 'Sensing Task #1')
          ..measures = SamplingSchema.common().getMeasureList(types: [DeviceSamplingPackage.SCREEN, DeviceSamplingPackage.MEMORY]));

    // when battery level is 10% then sample light
    study_3.addTriggerTask(
        SamplingEventTrigger(measureType: MeasureType(NameSpace.CARP, DeviceSamplingPackage.BATTERY), resumeCondition: BatteryDatum()..batteryLevel = 10),
        AutomaticTask(name: 'Sensing Task #1')..measures = SamplingSchema.common().getMeasureList(types: [SensorSamplingPackage.LIGHT]));

    study_3.addTriggerTask(
        ConditionalSamplingEventTrigger(
            measureType: MeasureType(NameSpace.CARP, DeviceSamplingPackage.BATTERY), resumeCondition: (datum) => (datum as BatteryDatum).batteryLevel == 10),
        AutomaticTask(name: 'Sensing Task #1')..measures = SamplingSchema.common().getMeasureList(types: [SensorSamplingPackage.LIGHT]));

...
| [carp_study_generator](./utilities/carp_study_generatorp) | A simple command line interface (CLI) to upload study protocols, informed consent and localization files to the CARP backend.  |  |

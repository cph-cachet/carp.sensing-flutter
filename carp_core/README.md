# CARP Mobile Sensing Framework in Flutter - Core Library
...
This library contains the core Flutter domain model for the CARP Mobile Sensing (CAMS) framework
and all of its supporting libraries, packages, etc.

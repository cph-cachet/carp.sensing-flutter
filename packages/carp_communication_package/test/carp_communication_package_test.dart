...
void main() {
  ...
  test('Privacy - TextMessageDatum', () {
    ...
    TextMessageDatum p_msg = TransformerSchemaRegistry.instance
  ...
  test('Privacy - TextMessageLogDatum', () {
    ...
    TextMessageLogDatum p_log = TransformerSchemaRegistry.instance
        .lookup(PrivacySchema.DEFAULT)
        .transform(log);
    //expect(p_msg.textMessage.address, isNot('25550446'));
    //expect(p_msg.textMessage.body, isNot('Hej Jakob'));
  ...
  test('Privacy - PhoneLogDatum', () {
    ...
    PhoneLogDatum p_log = TransformerSchemaRegistry.instance
        .lookup(PrivacySchema.DEFAULT)
        .transform(log);
    //expect(p_msg.textMessage.address, isNot('25550446'));
    //expect(p_msg.textMessage.body, isNot('Hej Jakob'));
  ...
  test('Calendar', () {
    ...
    CalendarDatum p_cal = TransformerSchemaRegistry.instance
        .lookup(PrivacySchema.DEFAULT)
        .transform(cal);
    print(_encode(p_cal));
  });

...
class ContextSamplingPackage implements SamplingPackage {
  ...
  void onRegister() {
    ...
    TransformerSchemaRegistry.instance.lookup(NameSpace.OMH).add(LOCATION, OMHGeopositionDatum.transformer);
    TransformerSchemaRegistry.instance.lookup(NameSpace.OMH).add(ACTIVITY, OMHPhysicalActivityDatum.transformer);
  }

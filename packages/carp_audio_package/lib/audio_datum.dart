...
class AudioDatum extends FileDatum {
  ...
  AudioDatum({String filename, this.startRecordingTime, this.endRecordingTime}) : super(filename: filename);
...
class NoiseDatum extends CARPDatum {
  static const DataFormat CARP_DATA_FORMAT = DataFormat(NameSpace.CARP, AudioSamplingPackage.NOISE);
